...
export const IncludeParentDirJson = false;
export const IncludeParentDirHtml = true;
...
export const HeaderFilename = '/HEADER.html';
export const FooterFilename = '/FOOTER.html';

// Enable/disable media metadata checking and display.
export const MediaMetadata = true;
// Check for a file in the media directory with the following extension
// to determine if said directory contains media info.
// export const MediaMetadataThumbnailExtension = ".tbn";
export const MediaMetadataThumbnailExtension = ['.tbn', '-poster.jpg'];
